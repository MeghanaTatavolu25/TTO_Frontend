                ...
                <Container style={{ maxWidth: "80%", fontFamily: 'Prompt', paddingTop: "2em" }}>
                    <Grid container spacing={0}>
                        <Grid item xs={6} sm={6} md={6}>
                            <p style={{ color: "#2C2C2C", fontSize: "2.7041vw", fontWeight: 600 }}>Technology Catalogue</p>
                        </Grid>
                        ...
                        <Grid item xs={7} sm={7} md={7} style={{ paddingTop: "4em" }}>
                            <a href={`/ResearchLab/${centers.Research_Lab}/${centers.ResearchLabCode}`} style={{ textDecoration: 'none',color: "#434343" }}>
                                <p style={{fontWeight: 600, fontSize: "1.66vw" }}>{centers.Research_Lab}</p>
                                <p style={{fontWeight: 400, fontSize: "1.0417vw", display: "-webkit-box", WebkitLineClamp: 6, WebkitBoxOrient: "vertical", overflow: "hidden", textOverflow: "ellipsis" }} >
                                {centers.Description}   
                                </p>
                            </a>
                    ...
                    <Grid container spacing={0} style={{ paddingTop: "5vw" }}>
                        <Grid item xs={6} sm={6} md={6}>
                            <p style={{ color: "#2C2C2C", fontSize: "2.7041vw", fontWeight: 600 }}>Startups</p>
                        </Grid>
                        <Grid item xs={6} sm={6} md={6} container justify="flex-end">
                        </Grid>
                        <Grid item xs={12} style={{ borderBottom: '0.27vw solid #535353', margin: '0.4vw 0' }}></Grid>
                        <Grid item xs={7} sm={7} md={7} style={{ paddingTop: "4em" }}>
                    ...
                    <Grid container spacing={0} style={{ paddingTop: "5vw" }}>
                        <Grid item xs={6} sm={6} md={6}>
                            <p style={{ color: "#2C2C2C", fontSize: "2.7041vw", fontWeight: 600 }}>Patents</p>
                        </Grid>
                        <Grid item xs={6} sm={6} md={6} container justify="flex-end">
                        </Grid>
                        <Grid item xs={12} style={{ borderBottom: '0.27vw solid #535353', margin: '0.4vw 0' }}></Grid>
                    ...
                    <Grid container spacing={0} style={{ paddingTop: "5vw" }}>
                        <Grid item xs={6} sm={6} md={6}>
                            <p style={{ color: "#2C2C2C", fontSize: "2.7041vw", fontWeight: 600 }}>Products</p>
                        </Grid>
                        <Grid item xs={12} style={{ borderBottom: '0.27vw solid #535353', margin: '0.4vw 0' }}></Grid>
                        <Grid item xs={7} sm={7} md={7} style={{ paddingTop: "4em" }}>
                    ...
                    <Grid container spacing={0} style={{ paddingTop: "5vw" }}>
                        <Grid item xs={6} sm={6} md={6}>
                            <p style={{ color: "#2C2C2C", fontSize: "2.7041vw", fontWeight: 600 }}>Contact us</p>
                        </Grid>
