            ...
            <Container style={{ maxWidth: "80%", fontFamily: 'Prompt', paddingTop: "3vw" }}>
                <Grid container spacing={0} >
                    ...
                    <Grid item xs={6} sm={6} md={6} container justify="flex-end">
                        {/* <Paper style={{ maxHeight: 60, marginRight: 40, backgroundColor: "#808080", padding: "0.35vw 0", borderRadius: "0.86vw" }}>
                            <span style={{ fontSize: "1.3vw", color: "#00000", paddingRight: 20 }}>&nbsp;<ResponsiveImage src={upload} maxHeight={20} maxWidth={40} />&nbsp; Upload</span>
                        </Paper> */}
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <label style={{ flex: '0 0 200px' }}>Faculty Name:
                                        <select value={techCenter} onChange={(e) => settechFaculty(e.target.value)} style={{ flex: '1', maxWidth: '300px' }}>
